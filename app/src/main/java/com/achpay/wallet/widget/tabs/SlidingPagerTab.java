...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    public SlidingPagerTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.SlidingPagerTab_indicatorColor, tabTextColor);
        ...
        dividerPadding = a.getDimensionPixelSize(R.styleable.SlidingPagerTab_pst_dividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.SlidingPagerTab_tabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.SlidingPagerTab_tabBackgrounds, tabBackgroundResId);
//        isSameLine = a.getBoolean(R.styleable.SlidingPagerTab_sameLine, isSameLine);
        scrollOffset = a.getDimensionPixelSize(R.styleable.SlidingPagerTab_scrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.SlidingPagerTab_pst_textAllCaps, textAllCaps);
